...
Este repositório é classificado como **architecture reference**. Exemplos, arquivos `.env.example`, Docker Compose e configurações devem ser tratados como referência e revisados antes de uso em ambientes controlados.
